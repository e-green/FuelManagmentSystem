...
public class FuelTypeController {
    ...
    @RequestMapping(value = "deleteFueltypeById", method = RequestMethod.POST, headers = "Accept=application/json")
    @ResponseBody
    public Integer deleteFuelTypeById(@RequestParam("fueltypeId")Long fueltypeId){

        Integer res= fuelTypeDAOService.deleteFueltypeById(fueltypeId);
            return res;
        }
