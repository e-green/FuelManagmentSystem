...
public class FuelTypeDAOControllerImpl extends AbstractDAOController<Fueltype,Long> implements FuelTypeDAOController {
    ...
    public Integer deleteFueltypeById(Long fuelTypeId){
        Session session = getSession();
        String hql = "delete from Fueltype where fuelTypeId= :fuelTypeId";
        int i = session.createQuery(hql).setLong("fuelTypeId", fuelTypeId).executeUpdate();
        return i;
