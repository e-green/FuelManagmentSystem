...
public class PumpingTypeController {
    ...
    @RequestMapping(value = "deletePumpingtypeById", method = RequestMethod.POST, headers = "Accept=application/json")
    @ResponseBody
    public Integer deletePumpingtypeById(@RequestParam ("pumpingtypeId") String pumpingtypeId){

        Integer res=pumpingTypeDAOService.deletePumoingtypeById(pumpingtypeId);
